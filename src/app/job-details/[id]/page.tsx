...
export default function JobDetails() {
   ...
   const seletedJob = jobData[index]
      ...
      <section className="bg-[#F6FAFF] py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="border border-[#dedede] rounded-2xl p-15 mb-12">
            <h1 className="text-3xl font-semibold text-[#273677] mb-8">{seletedJob?.title}</h1>
            <h2 className="text-xl font-regular text-[#273677] mb-5">{seletedJob?.subtitle}</h2>
            <div className="mb-6">
              <p className="text-[#32A2DC] text-xl mb-2">Description:</p>
              <p className="text-lg text-black">{seletedJob?.description}</p>
            </div>
