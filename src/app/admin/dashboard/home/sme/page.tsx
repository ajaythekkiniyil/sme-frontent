...
import { deleteSme } from "@/app/lib/sme";
...
export default function AdminSMEPage() {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => deleteSme(id),
    onSuccess: (_, id) => {
      setDeleteId(null);
      ...
      renderCell: (params) => (
        ...
        >
          ...
          <button
            onClick={() =>
              router.push(
                `/admin/dashboard/home/sme/update/${params.row.documentId}`
              )
            }
            className="text-blue-600 hover:text-blue-800 cursor-pointer mt-3"
          >
          ...
          {/* DELETE BUTTON */}
          <button
            onClick={() => setDeleteId(params.row.documentId)}
            className="text-red-600 hover:text-red-800 cursor-pointer mt-3"
          >
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-10">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            ...
            <div className="flex gap-3 w-full sm:w-auto">
              ...
              <button
                onClick={() => router.push('/admin/dashboard/home/sme/create')}
