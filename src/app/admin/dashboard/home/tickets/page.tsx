...
export const ticketsColumn: GridColDef[] = [
  ...
  { 
    ...
    headerName: "Phone Number", // Fixed Typo (was "Admin verified")
    flex: 1,
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden font-sans">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-slate-900 text-slate-300 border-r border-slate-800">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          ...
          <NavItem href="/admin/dashboard/home/tickets" icon={<Ticket size={20} />} label="Tickets" active />
        </nav>
        ...
        <header className="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-200 shadow-sm">
            ...
            <div className="flex items-center gap-6">
                <div className="hidden md:flex items-center bg-gray-100 rounded-full px-4 py-2 text-sm">
                    ...
                    <input type="text" placeholder="Search Tickets..." className="bg-transparent outline-none w-48 text-gray-700 placeholder-gray-400" />
                </div>
