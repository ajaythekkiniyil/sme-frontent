...
import { Wallet, Briefcase, Inbox } from "lucide-react";
...
import { Paperclip, Facebook, Github, Instagram, Youtube } from "lucide-react";

export default function Home() {

  const [isOpen, setIsOpen] = useState(false); // ✅ now works

  const services = [
    { title: "Wealth Management", image: "/images/services/wealth.jpg" },
    { title: "Estate Planning", image: "/images/services/estate.jpg" },
    { title: "Boosting Leads Through Target Campaign", image: "/images/services/leads.jpg" },
    { title: "Emails Marketing for Prudential", image: "/images/services/email.jpg" },
    { title: "KFC Brand Promo Strategy", image: "/images/services/kfc.jpg" }, 
  ];
...
<nav className="bg-white sticky top-0 z-50">
      <div className="container flex items-center justify-between mx-auto px-6 py-6">
        ...
        <ul className="hidden lg:flex space-x-8 font-sans text-gray-600 text-base">
        ...
        {/* Desktop Buttons (visible at ≥1024px) */}
  ...
  <div className="flex items-center text-gray-600 text-sm pt-3">
    ...
    <span>24/7 Support: (234) 109-666</span>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-light mb-6 lg:leading-22 leading-snug">
              Quick Reliable and{" "}
              <span className="text-[#32A2DC]">Confidential</span>
            </h1>
            <p className="text-gray-600 mb-8 text-base md:text-lg max-w-xl mx-auto lg:mx-0">
              Our Subject Matter Experts provide insights and solutions to your
              toughest challenges, helping you make informed business decisions
              quickly.
            </p>
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <button className="cursor-pointer px-6 py-3 bg-[#32A2DC] text-white rounded-full text-base md:text-lg shadow hover:bg-[#2790c7] transition">
                Become a Client
              </button>
              <button className="cursor-pointer px-6 py-3 border border-[#32A2DC] text-[#32A2DC] rounded-full text-base md:text-lg hover:bg-[#E6F5FC] transition">
                Become an SME
              </button>
            </div>
          </div>

          {/* Image (below text on mobile/tablet, right on desktop) */}
      ...
      {/* Background Image (Right Side for Desktop) */}
      ...
      {services.map((service, index) => (
        <div key={index} className="px-2 sm:px-3">
          <div className="relative rounded-xl overflow-hidden shadow-lg">
            ...
            />
            <div className="absolute bottom-0 left-0 w-full bg-black/40 text-white p-3 text-xs sm:text-sm md:text-base">
              {service.title}
            </div>
          </div>
        </div>
  ...
  <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
    ...
    <div className="bg-white border border-gray-200 rounded-2xl sm:rounded-3xl md:rounded-4xl p-6 sm:p-8 md:p-12">
      <form className="space-y-4 sm:space-y-6 md:space-y-8">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2 sm:mb-3">Full Name*</label>
          <input
            type="text"
        ...
        <div className="flex items-center space-x-2 text-gray-600 text-sm cursor-pointer hover:text-[#32A2DC] transition">
