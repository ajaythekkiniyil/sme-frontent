    ...
    <>
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="border border-[#dedede] rounded-2xl p-15 mb-12">
          <h1 className="text-3xl font-semibold text-[#273677] mb-8">Production & Artificial Lift</h1>
          <h2 className="text-xl font-regular text-[#273677] mb-5">Subject Matter Expert, ESP & Artificial Lift Systems</h2>
          <div className="mb-6">
          <p className="text-[#32A2DC] text-xl mb-2">Description:</p>
          <p className="text-lg text-black">Our SMEs in drilling help clients reduce non-productive time, enhance rig performance, and optimize bit selection. Ideal for experts with field or office-based drilling experience.</p>
          </div>

          <div className="mb-6">
          <p className="text-[#32A2DC] text-xl mb-2">Location:</p>
          <p className="text-lg text-black">Global</p>
          </div>
